...
Versao derivada do DuckHunt em JavaScript com um fluxo de IA aplicada para detectar os patos, mover a mira e disparar sozinha.

O projeto continua usando PixiJS para renderizacao, Green Sock para animacoes, Howler para audio e um worker de machine learning para inferencia no navegador.

## Diferencial desta versao

- A mira pode ser controlada por IA em vez de depender de clique humano.
- O worker de inferencia envia a melhor predicao detectada por frame.
- O jogo resolve o disparo da IA diretamente no fluxo do game, sem reutilizar o handler de clique da interface.

## Estado do repositorio

Este repositorio versiona o codigo-fonte e os assets estaticos usados pelo jogo. Os bundles gerados em `dist/` continuam fora do Git.
...
## Repository
Repositorio sugerido: `https://github.com/caarlosmoura/duckhunt-js-autoplay-ai`
